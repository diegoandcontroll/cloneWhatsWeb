...
export class WhatsController{
  ...
  initAuth(){
    ...
    this._user = new User(response.user.email);
      ...
      this._user.on('datachange', data =>{
        document.querySelector('title').innerHTML = `${data.name} WhatsClone`;
        ...
        if(data.photo){
          ...
          let perfilPhoto = this.el.myPhoto.querySelector('img');

          perfilPhoto.src = data.photo;
  ...
  elementsPrototype(){
    ...
    Element.prototype.toggle = function(){
      this.style.display = (his.style.display === 'none') ? 'block' : 'none';
      return this;
    }
  ...
  initEvents(){
        ...
        if(data.name){
          ...
          Chat.createIfNotExists(this._user.email, contact.email).then(chat =>{
            ...
            this._user.addContact(contact).then(() =>{
              ...
              console.info('contact add to firebase');
            });
          });
    ...
    this.el.inputPhoto.on('change', e =>{
      [...this.el.inputPhoto.files].forEach(item =>{
        Message.sendImage(this._contactActive.chatId, this._user.email, item);
      });
    });
    ...
    this.el.btnSendMicrophone.on('click', e =>{
      ...
      this._microphoneController.on('ready', e =>{
